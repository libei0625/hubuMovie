<template>
  <div @click="clickHandle">
    ...
    <i-grid-item i-class="no-border">
        <i-grid-icon>
            <image src="/static/grid/bargin.png" />
        </i-grid-icon>
        <i-grid-label>折扣</i-grid-label>
    </i-grid-item>
    <i-grid-item i-class="no-border">
        <i-grid-icon>
            <image src="/static/grid/movie.png" />
        </i-grid-icon>
        <i-grid-label>新片上映</i-grid-label>
    </i-grid-item>
    <i-grid-item i-class="no-border">
        <i-grid-icon>
    ...
    <i-grid-item i-class="no-border">
        <i-grid-icon>
            <image src="/static/grid/support.png" />
        </i-grid-icon>
        <i-grid-label>本周片单</i-grid-label>
    </i-grid-item>
</i-grid>
    <i-panel title="吃货推荐">
